...
. 从Cloud Volumes ONTAP 9.12.1 P2和9.13.0 P2开始、可以使用System Manager和ONTAP命令行界面创建最大大小为300 TiB的FlexVol卷。
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha-google-cloud.html["了解存储如何在Google Cloud中运行的Cloud Volumes ONTAP HA对中工作"^]。
